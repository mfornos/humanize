...
bc.. <humanize.version>1.0.0</humanize.version>
...
| messageFormatInstance | Returns an ICU or extended MessageFormat instance for the current thread. | - | ✔ | ✔ |
